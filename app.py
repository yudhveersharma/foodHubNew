...
app = Flask(__name__)
#import pandas as pd
lko_rest = pd.read_csv(r"C:\Users\sharm\OneDrive\Pictures\Documents\New folder (2)\Restaurant-Recommendation-System-main\Restaurant-Recommendation-System-main\food1.csv")
